...
let ProjectsComponent = class ProjectsComponent {
    constructor(projectService, memberService, teamService) {
...
let SelectedProjectComponent = class SelectedProjectComponent {
    constructor(projectService, router, sprintService, cardService) {
        this.projectService = projectService;
        this.router = router;
    ...
    getProyect() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.proyectId = yield this.router.snapshot.paramMap.get('id');
            yield this.projectService.getProject(this.proyectId).subscribe(data => {
    ...
    getSprints() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.sprintService.getSprints().subscribe(data => {
    ...
    getCards() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.cardService.getCards().subscribe(data => {
                console.log(data);
...
SelectedProjectComponent.ctorParameters = () => [
...
let SelectedSprintComponent = class SelectedSprintComponent {
    constructor(router) {
        this.router = router;
        this.toDo = [
            { issue: 'issue #1234',
...
SelectedSprintComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
...
let SelectedTeamComponent = class SelectedTeamComponent {
...
SelectedTeamComponent.ctorParameters = () => [
...
let TeamsComponent = class TeamsComponent {
    constructor(teamService, projectService) {
        this.teamService = teamService;
        this.projectService = projectService;
    }
    ngOnInit() {
...
let TeamServie = class TeamServie {
    constructor(http) {
        this.http = http;
